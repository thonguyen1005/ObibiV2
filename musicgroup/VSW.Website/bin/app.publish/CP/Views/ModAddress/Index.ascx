                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting text-center desktop"><%= GetSortLink("LatLong", "LatLong")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br />
                                                (<%=GetName(listItem[i].GetCity()) + " - "+ GetName(listItem[i].GetDistrict())+ " - "+ GetName(listItem[i].GetWard())%>)
                                            </td>
                                            <td class="text-center"><%= listItem[i].LatLong %></td>
