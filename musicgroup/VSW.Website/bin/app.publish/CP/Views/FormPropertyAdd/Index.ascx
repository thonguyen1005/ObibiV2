...
<%
    ...
    var property = WebPropertyService.Instance.GetByID_Cache(model.ParentID);
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Thuộc tính (<%=property != null ? property.Name : "" %>)</h3>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:ClosePropertyAdd('<%=model.ItemControl %>', <%=listItem[i].ID %>, <%=model.IsMultiple.ToString().ToLower() %>)">Chọn</a>
                                            </td>
                                        </tr>
                                        <%} %>
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "FormPropertyAdd";
        ...
        var VSWArrQT_QS = [
            '<%= model.ItemControl %>', 'ItemControl',
            '<%= model.IsMultiple.ToString().ToLower() %>', 'IsMultiple'
        ];
