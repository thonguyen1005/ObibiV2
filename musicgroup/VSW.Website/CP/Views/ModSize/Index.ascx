...
<%
    var model = ViewBag.Model as ModSizeModel;
    var listItem = ViewBag.Data as List<ModSizeEntity>;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Kích cỡ</h3>
        <div class="page-bar justify-content-between">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/{CPPath}/<%=CPViewPage.CurrentModule.Code%>/Index.aspx">Kích cỡ</a>
                </li>
            </ul>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-select select2" onchange="VSWRedirect()" size="1">
                                            ...
                                            <%= Utils.ShowDdlMenuByType("Sizes", model.LangID, model.MenuID)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
