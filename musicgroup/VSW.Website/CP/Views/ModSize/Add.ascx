...
<%
    ...
    var item = ViewBag.Data as ModSizeEntity;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Kích cỡ <small><%= model.RecordID > 0 ? "Chỉnh sửa": "Thêm mới"%></small></h3>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-select select2" name="MenuID" id="MenuID">
                                                            ...
                                                            <%= Utils.ShowDdlMenuByType("Sizes", model.LangID, item.MenuID)%>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
