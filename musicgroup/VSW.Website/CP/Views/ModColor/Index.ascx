...
<%
    ...
    var listItem = ViewBag.Data as List<ModColorEntity>;
%>
                            ...
                            <div class="row hidden-sm hidden-col">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-select select2" onchange="VSWRedirect()" color="1">
                                            <option value="0">(Tất cả)</option>
                                            <%= Utils.ShowDdlMenuByType("Colors", model.LangID, model.MenuID)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting text-center"><%= GetSortLink("Tên màu", "Name")%></th>
                                            <th class="sorting text-center"><%= GetSortLink("Mã màu", "ColorCode")%></th>
                                            <th class="sorting text-center w20p desktop"><%= GetSortLink("Ngày tạo", "Created")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div style="background-color: #<%= listItem[i].ColorCode%>; width: 100px; height: 25px; line-height: 25px; border: 1px solid #000;"><%= listItem[i].ColorCode%></div>
                                            </td>
