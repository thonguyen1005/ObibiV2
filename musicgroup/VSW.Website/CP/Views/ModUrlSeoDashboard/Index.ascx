...
<%
    var model = ViewBag.Model as ModUrlSeoDashboardModel;
    var listItem = ViewBag.Data as List<ModUrlSeoDashboardEntity>;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Seo đường dẫn thống kê</h3>
        <div class="page-bar justify-content-between">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/{CPPath}/<%=CPViewPage.CurrentModule.Code%>/Index.aspx">Seo đường dẫn thống kê</a>
                </li>
            </ul>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModUrlSeoDashboard";
