                ...
                <div class="portlet portlet">
                    <div class="portlet-title">
                        <div class="actions btn-set">
                            <button type="button" class="btn blue" onclick="if(document.vswForm.boxchecked.value>0){zebra_confirm('Thông báo !', 'Bạn chắc là mình muốn chọn chứ !', 'javascript:CloseProductVideoMulti()')}" data-toggle="tooltip" data-placement="bottom" data-original-title="Chọn"><i class="fa fa-check-circle"></i>Chọn</button>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <%if (!listItem[i].Check)
                                                    { %>
                                                <a href="javascript:CloseProductVideo(<%= listItem[i].ID %>)">Chọn</a>
                                                <%}
                                                    else
                                                    { %>
                                                <a href="javascript:void(0)" style="color: green;"><i class="fa fa-check-square"></i></a>
                                            ...
                                            <td>
                                                <a href="javascript:CloseProductVideo(<%= listItem[i].ID %>)"><%= listItem[i].Name%></a>
                                            </td>
...
<script type="text/javascript">
    ...
    var VSWController = "FormProductVideo";
