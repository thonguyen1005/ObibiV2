...
<form id="vswForm" name="vswForm" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="Colors" id="Colors" value="<%=item.Colors %>" />
    <input type="hidden" name="Sizes" id="Sizes" value="<%=item.Sizes %>" />
    <input type="hidden" name="FileOld" id="FileOld" value="<%=model.FileOld %>" />
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                                                <div class="portlet box blue-steel">
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="radio-list">
                                                                    <%=Utils.ShowRadioByByType2("StatusWareHouse", model.LangID,item.Status, "Status")  %>
                                                                </div>
                                                            </div>
                                                        </div>--%>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-inline">
                                                                    <input type="number" style="width: 150px;" class="form-control price" name="PricePromotion" value="<%=item.PricePromotion %>" />
                                                                    <span class="help-block text-primary"><%=Utils.NumberToWord(item.PricePromotion.ToString())%></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Khuyến mại đến ngày:</label>
                                                            <div class="col-md-9">
                                                                <input type="text" style="width: 150px; float: left;" class="form-control date" name="DatePromotion" id="DatePromotion" value="<%=(item.DatePromotion > DateTime.MinValue ? string.Format("{0:dd-MM-yyyy}",item.DatePromotion) : "") %>" />
                                                                <input type="time" class="form-control input-inline input-sm" name="TimePromotion" id="TimePromotion" value="<%=(item.DatePromotion > DateTime.MinValue ? string.Format("{0:hh:mm}",item.DatePromotion) : "") %>" placeholder="hh:mm">
                                                            </div>
                                                        </div>--%>
                                                            <div class="form-group row">
                                                            ...
                                                            <%-- <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Chuyên mục khác:</label>
                                                            <div class="col-md-9">
                                                                <select class="form-control select2" multiple style="width: 100%" name="MenuListID" id="MenuListID" title="Chọn chuyên mục">
                                                                    <option value="0">Root</option>
                                                                    <%= Utils.ShowDdlMenuByType5("Product", model.LangID, item.MenuListID)%>
                                                                </select>
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Chuyên mục kích cỡ:</label>
                                                            <div class="col-md-9">
                                                                <select class="form-control select2" name="SizeID" id="SizeID" onchange="GetSizes(this.value)">
                                                                    <option value="0">Root</option>
                                                                    <%= Utils.ShowDdlMenuByType("Sizes", model.LangID, item.SizeID)%>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Danh sách kích cỡ:</label>
                                                            <div class="col-md-9" id="list-size"></div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Chuyên mục màu sắc:</label>
                                                            <div class="col-md-9">
                                                                <select class="form-control select2" name="ColorID" id="ColorID" onchange="GetColors(this.value)">
                                                                    <option value="0">Root</option>
                                                                    <%= Utils.ShowDdlMenuByType("Colors", model.LangID, item.ColorID)%>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Danh sách màu sắc:</label>
                                                            <div class="col-md-9" id="list-color"></div>
                                                        </div>--%>
                                                            ...
                                                            <label class="col-md-3 col-form-label text-right">
                                                                Đặc điểm nổi bật<br />
                                                                (nhấn enter để ngăn cách)</label>
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="Summary" id="Summary" rows="" cols="5" style="height: 100px;"><%=item.Summary %></textarea>
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau(); return false;" value="Lấy mẫu biên tập">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap1'); return false;" value="Box1">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap2'); return false;" value="Box2">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap3'); return false;" value="Box3">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap4'); return false;" value="Box4">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap5'); return false;" value="Box5">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap6'); return false;" value="Box6">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap7'); return false;" value="Box7">
                                                                <input class="btn btn-primary" type="button" onclick="add_mau('TempBienTap8'); return false;" value="Box8">
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Thông số</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="Specifications" id="Specifications" rows="" cols=""><%=item.Specifications %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_mauthongso(); return false;" value="Lấy mẫu biên tập">
                                                                <input class="btn btn-primary" type="button" onclick="$('#FileUploadTSKT').click();" value="Lấy mẫu biên tập từ excel">
                                                                <input type="file" name="FileUploadTSKT" id="FileUploadTSKT" onchange="loadDataFromExcel(this);" style="display: none;" />
                                                            </div>
                                                        </div>--%>
                                                            <%-- <div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Khuyến mại</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="Promotion" id="Promotion" rows="" cols=""><%=item.Promotion %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_maupromotion(); return false;" value="Lấy mẫu biên tập">
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Thông tin thêm</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="Info" id="Info" rows="" cols=""><%=item.Info %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_mauinfo(); return false;" value="Lấy mẫu biên tập">
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Ưu đãi thêm</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="Promotion2" id="Promotion2" rows="" cols=""><%=item.Promotion2 %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_maupromotion2(); return false;" value="Lấy mẫu biên tập">
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Tại sao chọn</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="TaiSaoChon" id="TaiSaoChon" rows="" cols=""><%=item.TaiSaoChon %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_taisaochon(); return false;" value="Lấy mẫu biên tập">
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                            <label class="col-md-3 col-form-label text-right">Thông tin thêm</label>
                                                            <div class="col-md-12">
                                                                <textarea class="form-control ckeditor" name="InfoAdd" id="InfoAdd" rows="" cols=""><%=item.InfoAdd %></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <input class="btn btn-primary" type="button" onclick="add_infoadd(); return false;" value="Lấy mẫu biên tập">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-md-12">
                                                                <a href="https://fontawesome.com/v4.7.0/cheatsheet/" style="color: blue; text-decoration: underline;" target="_blank" data-toggle="tooltip" data-placement="bottom" data-original-title="Đường dẫn lấy tên icon">Đường dẫn lấy tên icon</a>
                                                            </div>
                                                        </div>--%>
                                                            <%--<div class="form-group row">
                                                ...
                                                <div class="portlet box blue-steel">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="caption d-flex justify-content-end" style="float: none;">
                                                            <a href="javascript:AddControlTextarea('tblPromotion','Promotion');" onclick=""><i class="fa fa-plus mr-1"></i></a>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                        <div class="form-group row">
                                                            <div class="col-md-12">
                                                                <table class="w100p">
                                                                    <tbody id="tblPromotion">
                                                                        ...
                                                                        <tr>
                                                                            <td class="w90p">
                                                                                <textarea class="form-control ckeditorRow" name="Promotion" id="Promotion<%=i %>"><%=arrPromotion[i] %></textarea>
                                                                            </td>
                                                                            <td class="text-center"><a href="javascript:;" onclick="removeRow(event)"><i class="fa fa-close"></i></a></td>
                                                                        </tr>
                                                                        <% } %>
