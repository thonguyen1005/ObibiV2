...
<%
    var model = ViewBag.Model as ModCongTrinhModel;
    var listItem = ViewBag.Data as List<ModCongTrinhEntity>;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Công trình</h3>
        <div class="page-bar justify-content-between">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/{CPPath}/<%=CPViewPage.CurrentModule.Code%>/Index.aspx">Công trình</a>
                </li>
            </ul>
                                    ...
                                    <div class="dataTables_search">
                                        ...
                                        <div class="table-group-actions d-inline-block">
                                            ...
                                            <select id="filter_menu" class="form-select select2" onchange="VSWRedirect()" size="1">
                                                ...
                                                <%= Utils.ShowDdlMenuByType("CongTrinh", model.LangID, model.MenuID)%>
                                            </select>
                                        </div>
                                        <div class="table-group-actions d-inline-block">
                                            <label>Vị trí</label>
                                            <select id="filter_state" class="form-select select2" onchange="VSWRedirect()" size="1">
                                                <option value="0">(Tất cả)</option>
                                                <%= Utils.ShowDdlByConfigkey("Mod.CongTrinhState", model.State)%>
                                            </select>
                                        </div>
                                        <div class="table-group-actions d-inline-block">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="smallsub">(<span>Mã</span>: <%= listItem[i].Code%>) - <a href="/<%=listItem[i].Code%>.html" style="color: red;" target="_blank">Xem website</a></p>
                                            </td>
                                            <td class="text-center">
                                                <%= Utils.GetMedia(listItem[i].File, 40, 40)%>
                                            </td>
                                            <td class="text-center"><%= GetName(listItem[i].GetMenu()) %></td>
                                            <td class="text-center"><%= Utils.ShowNameByConfigkey("Mod.CongTrinhState", listItem[i].State)%></td>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModCongTrinh";
