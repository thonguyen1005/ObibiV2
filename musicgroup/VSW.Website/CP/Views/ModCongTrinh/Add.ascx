...
<%
    ...
    var item = ViewBag.Data as ModCongTrinhEntity;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Công trình <small><%= model.RecordID > 0 ? "Chỉnh sửa": "Thêm mới"%></small></h3>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-select select2" name="MenuID" id="MenuID">
                                                            ...
                                                            <%= Utils.ShowDdlMenuByType("CongTrinh", model.LangID, item.MenuID)%>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-list">
                                                        <%= Utils.ShowCheckBoxByConfigkey("Mod.CongTrinhState", "ArrState", item.State)%>
                                                    </div>
                                                </div>
