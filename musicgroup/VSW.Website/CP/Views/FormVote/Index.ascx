                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting text-center "><%= GetSortLink("Đối tượng", "ProductID")%></th>
                                            <th class="sorting text-center "><%= GetSortLink("Nội dung", "Content")%></th>
                                            <th class="sorting text-center desktop"><%= GetSortLink("IP", "IP")%></th>
