...
<%
    ...
    var listItem = ViewBag.Data as List<ModWebUserMenuEntity>;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Phân loại khách hàng</h3>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting"><%= GetSortLink("Tên phân loại", "Content")%></th>
                                            <th class="sorting text-center w16p desktop"><%= GetSortLink("Số đơn hàng tối thiểu", "Count")%></th>
                                            <th class="sorting text-center w20p desktop"><%= GetSortLink("Ghi chú", "Note")%></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><%= listItem[i].Count %></td>
                                            <td class="text-center"><%= listItem[i].Note %></td>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModWebUserMenu";
