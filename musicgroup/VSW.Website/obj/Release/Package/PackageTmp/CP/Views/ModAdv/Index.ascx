                                ...
                                <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-right pull-right">
                                    <div class="table-group-actions d-inline-block">
                                        ...
                                        <select id="filter_menu" class="form-select select2" onchange="VSWRedirect()" size="1">
                                            ...
                                            <%= Utils.ShowDdlMenuByType2("Adv", model.LangID, model.MenuID)%>
                                        </select>
                                    </div>
                                    <div class="table-group-actions d-inline-block">
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting text-center desktop"><%= GetSortLink("URL", "URL")%></th>
                                            <th class="sorting text-center desktop"><%= GetSortLink("Chiều rộng", "Width")%></th>
                                            <th class="sorting text-center desktop"><%= GetSortLink("Chiều cao", "Height")%></th>
                                            <th class="sorting text-center desktop"><%= GetSortLink("Chuyên mục", "MenuID")%></th>
