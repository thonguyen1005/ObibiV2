...
<% 
    ...
    var parent = WebMenuService.Instance.GetByID_Cache(model.ParentID);
%>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <%if (model.ParentID == 0)
                                                { %>
                                            <th class="sorting text-center desktop"><%= GetSortLink("Loại dữ liệu", "Code")%></th>
                                            <%} %>
                                            ...
                                            <th class="sorting text-center w5p">Chọn</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:CloseWebMenu('<%=model.ItemControl %>', <%=listItem[i].ID %>, '<%=listItem[i].Type %>')">Chọn</a>
                                            </td>
                                        </tr>
                                        <%} %>
                                    </tbody>
