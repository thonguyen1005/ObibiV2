...
<%
    ...
    var listItem = ViewBag.Data as List<ModProductStateEntity>;
%>
...
<form id="vswForm" name="vswForm" method="post">
    ...
    <div class="page-content-wrapper">
        <h3 class="page-title">Vị trí sản phẩm</h3>
                                ...
                                <table class="table table-striped table-hover table-bordered dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting"><%= GetSortLink("Tên vị trí", "Name")%></th>
                                            <th class="sorting text-center w10p desktop"><%= GetSortLink("Giá trị", "MenuID")%></th>
    ...
    <script type="text/javascript">
        ...
        var VSWController = "ModProductState";
