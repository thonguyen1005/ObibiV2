...
namespace VSW.Lib.CPControllers
{
    [CPModuleInfo(Name = "Đánh giá",
        ...
        ShowInMenu = true,
        CssClass = "star")]
    public class ModVoteController : CPController
    {
        public ModVoteController()
        {
            //khoi tao Service
        ...
        public void ActionIndex(ModVoteModel model)
        {
            //sap xep tu dong
        ...
        public void ActionAdd(ModVoteModel model)
        {
            if (model.RecordID > 0)
            {
        ...
        public void ActionSave(ModVoteModel model)
        {
            if (ValidSave(model))
                SaveRedirect();
        }

        public void ActionApply(ModVoteModel model)
        {
            if (ValidSave(model))
                ApplyRedirect(model.RecordID, _item.ID);
        }

        public void ActionSaveNew(ModVoteModel model)
        {
            if (ValidSave(model))
        ...
        private bool ValidSave(ModVoteModel model)
        {
    ...
    public class ModVoteModel : DefaultModel
    {
