...
namespace VSW.Website.TagHelpers
{
    ...
    /// </summary>
    [HtmlTargetElement("vsw-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class EditorTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //disabled attribute
            //Do disable input sẽ không được submit form
            bool.TryParse(IsDisabled, out var disabled);
            bool.TryParse(IsReadonly, out var readOnly);
            ...
            {
                htmlAttributes.Add("autocomplete", "on");
            }
            ...
            string html = iconleftcontent + htmlOutput.RenderHtmlContent() + iconrightcontent + button + grouptext + labelErrorMessage;
